...
function GetJSONPropName(var P: PAnsiChar): TAnsiCharSection; overload;
...
begin
  Result := ParseJsonUtf8(PAnsiChar(s), GetStringLengthFast(Pointer(s)));
end;

const
  QUOTECHAR = #39;

{$region 'utf8 json parser'}
...
{$region 'json unicode parser'}
function GetJSONPropName(var P: PWideChar): TWideCharSection; overload;
var
  quote: WideChar;
begin
  Result.SetEmpty;
