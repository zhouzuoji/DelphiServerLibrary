...
*    2009.04.14  added overloaded string routines for RawByteString and UnicodeString               *
...
type
  ...
  public
    ...
    function  Read(var s: RawByteString): Integer; overload;
  end;
...
function  ZCompressStr(const s: RawByteString;
  level: TZCompressionLevel = zcDefault): RawByteString;

procedure ZCompressString(var result: RawByteString; const s: RawByteString;
...
function  ZCompressStrEx(const s: RawByteString;
  level: TZCompressionLevel = zcDefault): RawByteString;

procedure ZCompressStringEx(var result: RawByteString; const s: RawByteString;
  level: TZCompressionLevel = zcDefault); overload;
...
function  ZCompressStr2(const s: RawByteString; level: TZCompressionLevel;
  windowBits, memLevel: Integer; strategy: TZStrategy): RawByteString;

procedure ZCompressString2(var result: RawByteString; const s: RawByteString;
  level: TZCompressionLevel; windowBits, memLevel: Integer;
...
function  ZCompressStrWeb(const s: RawByteString): RawByteString;

procedure ZCompressStringWeb(var result: RawByteString; const s: RawByteString);
  overload;
...
function  ZDecompressStr(const s: RawByteString): RawByteString;

procedure ZDecompressString(var result: RawByteString; const s: RawByteString);
  overload;
...
function  ZDecompressStrEx(const s: RawByteString): RawByteString;

procedure ZDecompressStringEx(var result: RawByteString; const s: RawByteString);
  overload;
...
function  ZDecompressStr2(const s: RawByteString;
  windowBits: Integer): RawByteString;

procedure ZDecompressString2(var result: RawByteString; const s: RawByteString;
...
begin
  ...
  repeat
    stream.next_in := PByte(@readBuffer);

    repeat
      stream.avail_out := bufferSize;
      stream.next_out := PByte(@writeBuffer);
...
begin
  ...
  try
    ZDeflateEx(zstream, @param, TZReadFunction(@ZBufferRead), TZWriteFunction(@ZBufferWrite), zfFinish);
...
begin
  ...
  try
    ZInflateEx(zstream, @param, TZReadFunction(@ZBufferRead), TZWriteFunction(@ZBufferWrite), zfNoFlush);
...
procedure ZDecompressString(var result: RawByteString;
...
function TZCustomBuffer.Write(const s: RawByteString): Integer;
begin
...
function TZCustomBuffer.Read(var s: RawByteString): Integer;
begin
...
begin
  ...
  repeat
    FZStream.next_out := PByte(@outBuffer);
